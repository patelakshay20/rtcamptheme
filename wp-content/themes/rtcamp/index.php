                ...
                <div class="banner-holder">
                    <div class="banner-slider">
                        <?php
                            ...
                            $order = "ASC";
                            $wp_query->query('showposts=10&post_type=slider'.'&paged='.$paged.'&order='.$order);
                ...
                <div id="verticalTab">
                    <ul class="resp-tabs-list">
                        <?php
                            ...
                            $args = array('post_type' => 'page','sort_order' => 'asc','post_parent' => $homepage_id);
                        ...
                        <div>
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    {
                                        echo '<b style="padding-left: 15px;">Pages not Found</b>';
                                    }
                                ?>
                            </div>
                        </div>
